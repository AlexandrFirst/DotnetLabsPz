...
namespace Lab_4_Dot_Net.Controllers
{
    public class ExtradictionsController : Controller
    {
        ...
        public ActionResult Delete(int WorkerId, int FindingId, int OwnerId)
        {
            try
            {
                int result = _repository.Extradictions.Remove(_repository.Extradictions.Find(e => e.OwnerId == OwnerId
        ...
        public ActionResult Add(ExtradictionFormDTO dto)
        {
            try
            {
                ...
                int result = _repository.Extradictions.Add(dto, User.Identity.Name);
                if (result > 0)
